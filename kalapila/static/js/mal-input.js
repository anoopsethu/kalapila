...
function menuListener(){
           ...
           if($("#language-toggle").prop("checked") == true) 
             enable();
           else
             disable();
    ...
    function keypressEnabled(event){
        ...
        if(isToggleEvent(event)){
            disable();
            console.log("entered");
            $('#language-toggle').bootstrapToggle('off');
            return;
        } 
        ...
        if ($("#language-toggle").prop("checked") == true) {
            transliterateKey(event); //calling the Transilate Function 
            return true;
        }
    }
    ...
    disable();
    var menu = document.getElementById("language-toggle");
